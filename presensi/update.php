...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $id_presensi = (int)$_POST['id_presensi'];
    ...
    $stmt = mysqli_prepare($koneksi, "UPDATE presensi SET id_pegawai=?, tanggal=?, status_hadir=?, jam_masuk=?, jam_keluar=?, terlambat_menit=?, lembur_menit=? WHERE id_presensi=?");
    mysqli_stmt_bind_param($stmt, "issssiii", $id_pegawai, $tanggal, $status_hadir, $jam_masuk, $jam_keluar, $terlambat_menit, $lembur_menit, $id_presensi);
